...
class PathExample extends StatelessWidget {
  ...
  const PathExample({super.key, required this.height, required this.width,  this.thickness = 20,  this.backgroundColor =Colors.lightBlue,  this.foregroundColor = const Color.fromARGB(255, 33, 91, 139), required this.totalValue, required this.currentValue, required this.child});
  @override
